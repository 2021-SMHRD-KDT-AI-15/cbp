			...
			<div class="container">
				...
				<section class="box feature">
					<ul class="special">
						...
						<h2>40일 목표로!</h2>
						<p>40일을 목표로 삼아 당신의 일정 관리를 도와드립니다!</p>

						<li><a href="#" class="icon solid fa-smoking-ban"><span
								class="label">Smokingban</span></a></li>
						<p></p>
						<h2>금연을 통해!</h2>
						<p>일정관리로 금연 성공을 이뤄보세요!</p>

						<li><a href="#" class="icon solid fa-heartbeat"><span
								class="label">Heartbeat</span></a></li>
						<p></p>
						<h2>더 건강하게!</h2>
						<p>저희 서비스와 함께 더 건강해진 자신을 체험해보세요!</p>
					</ul>
			</div>
		</section>
